...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ trans('site.vendor-dashboard') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        {{--                                            </li>--}}
                        <li>
                            <a href="{{ route('vendor-order-index') }}">{{ trans('site.vendor-dashboard') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
