...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Vendor Verification') }}</h4>
                      <ul class="links">
                        <li>
                          <a href="{{ route('vendor-dashboard') }}">{{ __('site.dashboard') }}</a>
                        </li>
                      <li>
                        <a href="{{ route('vendor-verify') }}">{{ __('site.Vendor Verification') }}</a>
                      </li>
                      </ul>
                  </div>
                </div>
...
<div class="alert alert-success validation" style="">
            <p class="text-left"><div class="text-center"><i class="fas fa-check-circle fa-4x"></i><br><h3>Verfiy</h3></div></p>
      </div>
      ...
      @else
                        ...
                        @include('includes.admin.form-both')
                                ...
                                <form   action="{{route('vendor-verify-submit')}}" method="POST" enctype="multipart/form-data">
                                  {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="input-field" name="text" required="" placeholder=" {{ __('site.description') }}"></textarea>
                          </div>
                        </div>
