...
@section('content')
    ...
    <div class="content-area">
        ...
        {{ BsForm::resource('prod')->putModel($data, route('vendor-prod-catalog-update', $data)) }}
                            ...
                            <div class="product-description">
                                <div class="body-area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input name="price" step="0.1" type="number" class="input-field form-control" placeholder="{{ trans('site.price') }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">@lang('site.price_dollars') *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <input type="text" name="price_dollars" value="{{$data->price_dollars}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">@lang('site.price_egyptian') *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <input type="text" name="price_egyptian" value="{{$data->price_egyptian}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">@lang('site.price_riyals') *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <input type="text" name="price_riyals" value="{{$data->price_riyals}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">@lang('site.price_sudanese') *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <input type="text" name="price_sudanese" value="{{$data->price_sudanese}}" class="form-control">
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        jQuery('input.discount').change(function () {
            ...
            if (selecttype == 'Fixed value')
                ...
                jQuery('input#afterdiscount').val(price * (discount / 100));
