...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">@lang('site.products')</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('vendor-prod-index') }}">@lang('site.products')</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- GALLERY MODAL --}}
		...
		<div class="modal fade" id="setgallery" tabindex="-1" role="dialog" aria-labelledby="setgallery" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">angg->lang619 }}</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
          ...
          '<i class="fas fa-plus"></i> <span class="remove-mobile"><span>'+mesg+
          '</a>'+
          '</div>');
      });
                    ...
                    success:function(data){
                      if(data[0] == 0)
                      {
	                    $('.selected-image .row').addClass('justify-content-center');
	      				$('.selected-image .row').html('<h3>{{ trans('site.image') }}</h3>');
     				  }
                      else {
