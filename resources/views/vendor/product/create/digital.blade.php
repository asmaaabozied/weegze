...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"> @lang('site.Digital Product')<a class="add-btn" href="{{ route('vendor-prod-types') }}"><i
				...
				<ul class="links">
					...
					<li>
						<a href="{{ route('vendor-prod-digital-create') }}">@lang('site.Digital Product')</a>
					</li>
				</ul>
			</div>
		</div>
