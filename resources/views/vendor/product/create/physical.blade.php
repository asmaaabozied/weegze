...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"> @lang('site.Physical Product')<a class="add-btn" href="{{ route('vendor-prod-types') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-prod-digital-create') }}">@lang('site.Physical Product')</a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" name="seo_check" class="checkclick"
                                                           id="allowProductSEO"
                                                           value="1">
                                                    <label for="allowProductSEO">{{ __("site.Allow Product SEO") }}</label>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="add-product-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <button class="addProductSubmit-btn btn-primary"
