...
{{--                gs->show_stock == 0 ? '' : $product->stock }}  langg->lang79 }}--}}
            ...
            <li class="review-count">
              <p>{{count($product->ratings)}}  {{trans('site.ratings')}}</p>
            </li>
        ...
        <div class="info-meta-2">
          <ul>
            ...
            <li>
              <p> {{trans('site.platform')}}: <b>{{ $product->platform }}</b></p>
            </li>
            @endif

            @if($product->region != null)
            <li>
              <p> {{trans('site.region')}}: <b>{{ $product->region }}</b></p>
            </li>
            @endif

            @if($product->licence_type != null)
            <li>
              <p> {{trans('site.licence_type')}}: <b>{{ $product->licence_type }}</b></p>
            </li>
            @endif
      ...
      @if(!empty($product->size))
          <div class="mproduct-size">
              <p class="title"> {{trans('site.size')}} :</p>
              <ul class="siz-list">
                  @php
                      $is_first = true;
                  @endphp
      ...
      <div class="info-meta-3">
            ...
            @endif
              ...
              <li class="addtocart">
                <a href="{{ route('affiliate.product', $product->slug) }}" target="_blank"><i
                    class="icofont-cart"></i>  @lang('site.affiliate')</a>
              </li>
              @else
              @if($product->stock === 0)
              <li class="addtocart">
                <a href="javascript:;" class="cart-out-of-stock">
                  <i class="icofont-close-circled"></i>
                    {{trans('site.addtocart')}}</a>
              </li>
              @else
              <li class="addtocart">
                <a href="javascript:;" id="maddcrt"><i class="icofont-cart"></i>{{trans('site.addtocart')}}</a>
              </li>

              <li class="addtocart">
                <a id="mqaddcrt" href="javascript:;">
                  <i class="icofont-cart"></i> {{trans('site.addtocart')}}
                </a>
              </li>
              @endif
        ...
        @if($product->ship != null)
          <p class="estimate-time"> @lang('site.ship'): <b> {{ $product->ship }}</b></p>
        @endif
        @if( $product->sku != null )
        <p class="p-sku">
           @lang('site.sku'): <span class="idno">{{ $product->sku }}</span>
        </p>
        @endif
