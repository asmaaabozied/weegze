                            ...
                            <form  action="{{route('front.contact.submit')}}" method="POST">
                                ...
                                @include('partials._errors')
                                    ...
                                    <div class="form-input">
                                        <input type="text" name="name" placeholder="{{trans('site.name')}}" required="">
                                        <i class="icofont-user-alt-5"></i>
                                    </div>
                                    <div class="form-input">
                                            <input type="text" name="phone"  placeholder="{{trans('site.phone')}}" onkeypress="CheckSpace(event)">
																						<i class="icofont-ui-call"></i>
                                    </div>
                                    <div class="form-input">
                                            <input type="email" name="email"  placeholder="{{trans('site.email')}}" required="" onkeypress="CheckSpace(event)">
																						<i class="icofont-envphoneelope"></i>
                                    </div>
                                    <div class="form-input">
                                            <textarea name="text" placeholder="{{trans('site.description')}} *" required=""></textarea>
                                    </div>
...
{{--                                        </li>--}}
{{--                                        <li>--}}
{{--                                                <input name="codes" type="text" class="input-field" placeholder="{{trans('site.code')}} " required="">--}}
...
{{--                                    @endif--}}
                                    ...
                                    <button class="submit-btn" type="submit">{{ trans('site.save')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="right-area">
                        ...
                        @endif
                                ...
                                <div class="social-links">
                                    <h4 class="title">@lang('site.title1') :</h4>
                                    <ul>
