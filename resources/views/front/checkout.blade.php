                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-step1-tab" data-toggle="pill"
                                       href="#pills-step1" role="tab" aria-controls="pills-step1" aria-selected="true">
                                        <span>1</span> {{ trans('site.address')}}
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" id="pills-step3-tab" data-toggle="pill"
                                       href="#pills-step3" role="tab" aria-controls="pills-step3" aria-selected="false">
                                        <span>3</span> {{trans('site.payments')}}
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="content">
                                                ...
                                                @if(!Auth::check())
                                                    <div class="row">
                                                        <div class="col-lg-12 mt-3">
                                                            ...
                                                            <label for="open-pass">@lang('site.paymentdetails')</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="billing-address">
                                                <h5 class="title">
                                                    @lang('site.paymentdetails')
                                                </h5>
                                                <div class="row">
                                                    <div class="col-lg-6 {{ $digital == 1 ? 'd-none' : '' }}">
                                                        <select class="form-control" id="shipop" name="shipping"
                                                                required="">
                                                            <option value="shipto">@lang('site.charge')</option>
                                                            <option value="pickup">@lang('site.finds')</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 d-none" id="shipshow">
                                                        <select class="form-control nice" name="pickup_location">
                                                            @foreach($pickups as $pickup)
                                                                <option
                                                                    value="{{$pickup->location}}">{{$pickup->location}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="city"
                                                               placeholder="{{ trans('site.city') }}" required=""
                                                               value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->city : '' }}">
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="zip"
                                                               placeholder="{{ trans('site.zip') }}" required=""
                                            ...
                                            <div class="row {{ $digital == 1 ? 'd-none' : '' }}">
                                                <div class="col-lg-12 mt-3">
                                                    ...
                                                    <label
                                                        for="ship-diff-address">@lang('site.Ship to a different address')</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <input class="form-control ship_input" type="text"
                                                               ...
                                                               id="shipping_address"
                                                               placeholder="{{ trans('site.address') }}">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <input class="form-control ship_input" type="text"
                                                               name="shipping_city"
                                                               id="shipping_city"
                                                               placeholder="{{ trans('site.city') }}">
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control ship_input" type="text"
                                                               name="shipping_zip"
                                                               id="shippingPostal_code"
                                                               placeholder="{{ trans('site.shipping_zip') }}">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" id="Order_Note" class="form-control"
                                                               name="order_notes"
                                                               placeholder="{{ trans('site.notes') }} ({{ trans('site.notes') }})">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12  mt-3">
                                                    <div class="bottom-area paystack-area-btn">
                                                        <button type="submit"
                                                                class="mybtn1">{{ trans('site.submit') }}</button>
                                                    </div>
                                                    ...
                                                    <div class="order-item">
                                                        ...
                                                        <div class="product-content">
                                                            ...
                                                            <div class="unit-price">
                                                                <h5 class="label">@lang('site.price'): </h5>
                                                                <p>{{ App\Models\Product::convertPrice($product['item']['price']) }}</p>
                                                            </div>
                                                            @if(!empty($product['size']))
                                                                <div class="unit-price">
                                                                    <h5 class="label">@lang('site.size') : </h5>
                                                                    <p>{{ str_replace('-',' ',$product['size']) }}</p>
                                                                </div>
                                                            @endif
                                                            @if(!empty($product['color']))
                                                                <div class="unit-price">
                                                                    <h5 class="label">@lang('site.color') : </h5>
                                                                    <span id="color-bar"
                                                            ...
                                                            @endif
                                                            <div class="quantity">
                                                                <h5 class="label">@lang('site.quantity') : </h5>
                                                                <span class="qttotal">{{ $product['qty'] }} </span>
                                                            </div>
                                                            <div class="total-price">
                                                                <h5 class="label">@lang('site.total') : </h5>
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    <div class="bottom-area">
                                                        <a href="javascript:;" id="step1-btn"
                                                           class="mybtn1 mr-3">@lang('site.back')</a>
                                                        <a href="javascript:;" id="step3-btn"
                                                           class="mybtn1">@lang('site.follow')</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    <div class="bottom-area">
                                                        ...
                                                        <button type="submit" id="final-btn"
                                                                class="mybtn1">@lang('site.follow')</button>
                                                    </div>
                ...
                @if(Session::has('cart'))
                    <div class="col-lg-4">
                        <div class="right-area">
                            <div class="order-box">
                                <h4 class="title">@lang('site.price') @lang('site.details')</h4>
                                <ul class="order-list">
                                    <li>
                                        <p>
                                            @lang('site.sum')
                                    ...
                                    @else
                                        ...
                                        <li class="discount-bar d-none">
                                            <p>
                                                angg->lang145 }} <span class="dpercent"></span>
                                            </p>
                                            <P>
                                                <b id="discount">{{ $curr->sign }}{{ Session::get('coupon') }}</b>
                                            </P>
                                ...
                                <div class="cupon-box">
                                    ...
                                    <div id="coupon-link">
                                        ...
                                        @lang('site.discountcode')
                                    </div>

                                    <form id="check-coupon-form" class="coupon">
                                        <input type="text" placeholder="{{ trans('site.code') }}" id="code" required=""
                                               autocomplete="off">
                                ...
                                @if($digital == 0)
                                    ...
                                    <div class="packeging-area">
                                        <h4 class="title">@lang('site.Shipping Method')</h4>
                                    ...
                                    <div class="packeging-area">
                                        <h4 class="title">@lang('site.Packaging')</h4>
                                    ...
                                    <div class="final-price">
                                        <span>@lang('site.final price')</span>
                                        @if(Session::has('coupon_total'))
                                            @if($gs->currency_format == 0)
                                        ...
                                        <form action="{{ route('user.login.submit') }}" method="POST">
                                            ...
                                            <div class="form-input">
                                                <input type="password" class="Password" name="password"
                                                       placeholder="{{ trans('site.password')}}" value="1234"
                                                       required="">
                                    ...
                                    <div class="login-form signup-form">
                                        ...
                                        <form action="{{route('user-register-submit')}}"
                                            ...
                                            <input id="processdata" type="hidden"
                                                   value="{{trans('site.added_succesfully')}}">
                                            <button type="submit" class="submit-btn">{{ trans('site.submit') }}</button>
