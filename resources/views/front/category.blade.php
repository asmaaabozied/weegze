   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            <ul class="pages">
               <li>
                  <a href="{{route('front.index')}}">@lang('site.dashboard')</a>
               </li>
               @if (!empty($cat))
               <li>
               ...
               <li>
                  <a href="{{route('front.category')}}">{{ trans('site.category') }}</a>
               </li>
               @endif
         ...
         <div class="col-lg-9 order-first order-lg-last ajax-loader-parent">
            <div class="right-area" id="app">
               ...
               <div class="categori-item-area">
                 ...
                 <div id="ajaxLoader" class="ajax-loader" style="background: url({{asset('assets/images/')}}) no-repeat scroll center center rgba(0,0,0,.6);"></div>
               </div>
