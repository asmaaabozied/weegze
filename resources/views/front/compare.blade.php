...
{{--									{{ $langg->lang70 }}--}}
								...
								<table class="table table-bordered mb-0">
									<tbody>
										<tr>
											...
											<td class="first-column top">1</td>
										...
										<tr>
											...
											<tr>
													...
													<td class="c{{$product['item']['id']}}">
														...
														<a href="javascript:;" data-href="{{ route('product.cart.add',$product['item']['id']) }}" class="btn__bg add-to-cart">{{trans('site.addtocart')}}</a>
													<a href="{{ route('product.cart.quickadd',$product['item']['id']) }}" class="btn__bg">{{trans('site.bugnow')}}</a>
															@endif
													</td>
													@endforeach
												</tr>
			...
			<div class="page-center">
				<h4 class="text-center">
                    ...
                    @lang('site.messages.user_dataNotExist')
                </h4>
			</div>
