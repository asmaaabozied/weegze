        ...
        <div class="row">
          ...
          <div class="xzoom-container">
                    ...
                    <ul>
                      ...
                      <li class="product-isstook">
                        <p>
                          ...
                          {{ $gs->show_stock == 0 ? '' : $productt->stock }} {{ trans('site.stock')}}
                        </p>
                      </li>
                      @endif
                      @endif
                      ...
                      <li class="review-count">
                        <p>{{count($productt->ratings)}} ratings</p>
                      </li>
            ...
            <div class="product-price">
              <p class="title">@lang('site.price') :</p>
                  ...
                  <div class="info-meta-2">
                    <ul>
                      ...
                      <li>
                        <p>platform: <b>{{ $productt->platform }}</b></p>
                      </li>
                      @endif

                      @if($productt->region != null)
                      <li>
                        <p>region: <b>{{ $productt->region }}</b></p>
                      </li>
                      @endif

                      @if($productt->licence_type != null)
                      <li>
                        <p>licence_type: <b>{{ $productt->licence_type }}</b></p>
                      </li>
                      @endif
                  ...
                  <div class="product-size">
                    <p class="title">@lang('site.size') :</p>
                    <ul class="siz-list">
                      @php
                      $is_first = true;
                      @endphp
                  ...
                  <div class="product-color">
                    <p class="title">@lang('site.color'):</p>
                    <ul class="color-list">
                      @php
                      $is_first = true;
                      @endphp
                    ...
                    <ul class="meta-list">
                      ...
                      <li class="addtocart">
                        <a href="{{ route('affiliate.product', $productt->slug) }}" target="_blank"><i
                            class="icofont-cart"></i> affiliate223</a>
                      </li>
                      @else
                      @if($productt->emptyStock())
                      <li class="addtocart">
                      ...
                      @else
                      <li class="addtocart">
                          <a id="addcrt"><span  class="add-to-cart add-to-cart-btn" data-href="{{ route('product.cart.add',$productt->id) }}">
																	<i class="icofont-cart"></i> @lang('site.addtocart')
                          </a>
                          {{--                        <a href="{{ route('product.cart.add',$productt->id) }}" id="addcrt"><i class="icofont-cart"></i>@lang('site.addtocart')</a>--}}
                      </li>

                      <li class="addtocart">
                        <a id="qaddcrt" href="{{ route('product.cart.quickadd',$productt->id) }}">
                          <i class="icofont-cart"></i>@lang('site.bugnow')
                        </a>
                      </li>
                      @endif
                  ...
                  @if($productt->ship != null)
                    <p class="estimate-time">ship: <b> {{ $productt->ship }}</b></p>
                  @endif
                  @if( $productt->sku != null )
                  <p class="p-sku">
                      sku : <span class="idno">{{ $productt->sku }}</span>
                  </p>
                  @endif
      @if($gs->is_report)
...
{{--      --}}{{-- PRODUCT REPORT SECTION --}}
                    ...
                    <div class="report-area">
                        <a href="javascript:;" data-toggle="modal" data-target="#report-modal"><i class="fas fa-flag"></i>{{trans('site.Reports')}}</a>
                    </div>

                    @else

                    <div class="report-area">
                        <a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg"><i class="fas fa-flag"></i> {{trans('site.Reports')}}</a>
                    </div>
                    @endif
                  ...
                  <div id="product-details-tab">
                    <div class="top-menu-area">
                      <ul class="tab-menu">
                        ...
                        <li><a href="#tabs-3">tabs-3({{ count($productt->ratings) }})</a></li>
                        @if($gs->is_comment == 1)
                        <li><a href="#tabs-4">tabs-4(<span
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              <h5 class="text-center"><a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg"
                                  class="btn login-btn mr-1">centercenter</a> center1</h5>
                              <br>
                            </div>
                          </div>
                          @endif
...
{{--        <h3>{{ $langg->lang770 }}</h3>--}}
        <table class="table">
          <tr>
            <th>whole_sell_qty</th>
            <th>whole_sell_discount</th>
          </tr>
          @foreach($productt->whole_sell_qty as $key => $data1)
          <tr>
            <td>{{ $productt->whole_sell_qty[$key] }}+</td>
            <td>{{ $productt->whole_sell_discount[$key] }}% whole_sell_discount</td>
          </tr>
          @endforeach
        </table>
      </div>
          ...
          <p class="stor-name">
           @if( $productt->user_id  != 0)
              @if(isset($productt->user))
                ...
                <br>
                <a class="verify-link" href="javascript:;"  data-toggle="tooltip" data-placement="top" title="angg->lang783 }}">
                    langg->lang783 }}
...
{{--            <span>{{ $langg->lang248 }}</span>--}}
    ...
    @if( $productt->user_id  != 0)
        <a href="{{ route('front.vendor',str_replace(' ', '-', $productt->user->shop_name)) }}" class="view-stor">{{ trans('site.vendor') }}</a>
    @endif
...
<div class="message-modal">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="vendorformLabel">trendingtrending</h5>
              ...
              <div class="col-md-12">
                <div class="contact-form">
                  <form id="emailreply1">
                    ...
                    <button class="submit-btn" id="emlsub" type="submit">@lang('site.submit')</button>
                  </form>
                </div>
              </div>
            </div>
  ...
  <div class="modal" id="vendorform1" tabindex="-1" role="dialog" aria-labelledby="vendorformLabel1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="vendorformLabel1">vendorformLabel1</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
              ...
              <div class="col-md-12">
                <div class="contact-form">
                  <form id="emailreply">
                    ...
                    <button class="submit-btn" id="emlsub1" type="submit">@lang('site.submit') </button>
                  </form>
                </div>
              </div>
            </div>
 ...
 <div class="gocover" style="background: url({{ asset('assets/images/') }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                    ...
                    <div class="login-area">
                        <div class="header-area forgot-passwor-area">
                            <h4 class="title">g->lang777 }}</h4>
                            <p class="text">ngg->lang778 }}</p>
                        </div>
                            ...
                            <form id="reportform" action="{{ route('product.report') }}" method="POST">
                              ...
                              @include('includes.admin.form-login')
                                ...
                                <div class="form-input">
                                    <input type="text" name="title" class="User Name" placeholder="" required="">
                                    <i class="icofont-notepad"></i>
                                </div>

                                <div class="form-input">
                                  <textarea name="note" class="User Name" placeholder="" required=""></textarea>
                                </div>
