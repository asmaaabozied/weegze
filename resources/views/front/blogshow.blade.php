                  ...
                  <ul class="post-meta">
                    ...
                    <li>
                      <a href="javascript:;">
                        ...
                        {{ $blog->views }} {{ trans('site.view') }}
                      </a>
                    </li>
                    <li>
                      <a href="javascript:;">
                        <i class="icofont-speech-comments"></i>
                        {{trans('site.source')}} : {{ $blog->source }}
                      </a>
                    </li>
                  </ul>
          ...
          <div class="blog-aside">
            <div class="serch-form">
              <form action="{{ route('front.blogsearch') }}">
                <input type="text" name="search" placeholder="{{trans('site.search')}}" required="">
                <button type="submit"><i class="icofont-search"></i></button>
              </form>
            </div>
            <div class="categori">
              <h4 class="title">{{ trans('site.title1') }}</h4>
