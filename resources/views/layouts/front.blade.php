...
{{--                        <img src="{{asset('assets/images/1619291885logo.png')}}" alt="">--}}
    ...
    @elseif(isset($productt))
        ...
        <title>{{substr($productt->name, 0,11)."-"}}title</title>
    @else
                ...
                <div class="subscribePreloader__text text-center">
                    ...
                    <form action="{{route('front.subscribe')}}" id="subscribeform" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <button id="sub-btn" type="submit">@lang('site.save')</button>
                        </div>
                    </form>
                </div>
            </div>
                                    ...
                                    <div class="currency-selector">
                                        ...
                                        <select name="currency" class="currency selectors nice">
                                            @foreach(DB::table('currencies')->get() as $currency)
                                                <option
                                                    value="{{route('front.currency',$currency->id)}}" {{ Session::has('currency') ? ( Session::get('currency') == $currency->id ? 'selected' : '' ) : (DB::table('currencies')->where('is_default','=',1)->first()->id == $currency->id ? 'selected' : '') }} >{{$currency->sign}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </li>
                                    ...
                                    <li class="login">
                                        <a href="{{ route('user.login') }}" class="sign-log">
                                            <div class="links">
                                                {{--                                                {{ $langg->lang12 }}--}}
                                                @lang('site.login')
                                                <span class="sign-in"></span> <span>|</span>
                                                {{--                                                {{ $langg->lang13 }}--}}
                                                @lang('site.register')
                                ...
                                @else
                                    <li class="profilearea my-dropdown">
                                        <a href="javascript: ;" id="profile-icon" class="profile carticon">
												<span class="text">
													<i class="far fa-user"></i>	{{ trans('site.profiles') }} <i
                                            ...
                                            <ul class="profile-links">
                                                <li>
                                                    <a href="{{ route('user-dashboard') }}"><i
                                                            class="fas fa-angle-double-right"></i> @lang('site.user-dashboard')
                                                    </a>
                                                </li>
                                                @if(Auth::user()->IsVendor())
                                                    ...
                                                    <li>
                                                        <a href="{{ route('vendor-dashboard') }}"><i
                                                                class="fas fa-angle-double-right"></i>@lang('site.vendor-dashboard')
                                                        </a>
                                                    </li>
                                                @endif
                                                ...
                                                <li>
                                                    <a href="{{ route('user-profile') }}"><i
                                                            class="fas fa-angle-double-right"></i> @lang('site.profile')
                                                    </a>
                                                </li>

                                                <li>
                                                    <a href="{{ route('user-logout') }}"><i
                                                            class="fas fa-angle-double-right"></i> @lang('site.logout')
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        @if(Auth::check())
                                            @if(auth()->user()->is_vendor == 2)
                                                <a href="{{ route('vendor-dashboard') }}"
                                                   class="sell-btn">@lang('site.vendor')</a>
                                            @else
                                                <a href="{{ route('user-package') }}"
                                                   class="sell-btn">@lang('site.sale')</a>
                                            @endif
                                    </li>
                                @else
                                    <li>
                    ...
                    <div class="search-box">
                        <div class="categori-container" id="catSelectForm">
                            <select name="category" id="category_select" class="categoris">
                                									<option value="" selected>  @lang('site.selectcategory') </option>
                                @foreach(\App\Models\Category::get() as $data)
                                    <option
                                        value="{{ $data->slug }}" {{ Request::route('category') == $data->slug ? '' : '' }}>{{ $data->name }}</option>
                                @endforeach
                            </select>
                        </div>
...
{{--                        <form id="searchForm" class="search-form"--}}
{{--                              action="{{ route('front.searchcategory') }}"--}}
{{--                              method="GET">--}}
                            ...
                            @endif
                            <input type="text" id="prod_name" name="search" placeholder=""
            ...
            <div class="col-lg-2 col-sm-6 col-7 remove-padding order-lg-last">
                <div class="helpful-links">
                    <ul class="helpful-links-inner">
                        ...
                        <li class="wishlist" data-toggle="tooltip" data-placement="top" title="">
                            {{--                                {{ $langg->lang9 }}--}}
                            @if(Auth::guard('web')->check())
                        ...
                        <li class="compare" data-toggle="tooltip" data-placement="top" title="">
                            {{--                                {{ $langg->lang10 }}--}}
        ...
        <div class="row align-items-center mainmenu-area-innner">
                    ...
                    <div class="categories_menu_inner">
                        <ul>
                            ...
                            @foreach(\App\Models\Category::get() as $category)
                                ...
                                @if($i == 15)
                                    <li>
                                        <a href="{{ route('frontends.categories') }}"><i
                                                class="fas fa-plus"></i> {{ trans('site.categories') }} </a>
                                    </li>
                                    @break
                                @endif
            ...
            <div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
                <nav hidden>
                    ...
                    <ul class="menu">
                        @if($gs->is_home == 1)
                            <li><a href="{{ route('front.index') }}">@lang('site.dashboard')</a></li>
                        @endif
                        <li><a href="{{ route('frontend.blogs') }}"> @lang('site.Blogs')</a></li>
                        @if($gs->is_faq == 1)
                            <li><a href="{{ route('frontend.faq') }}">@lang('site.Faq')</a></li>
                        @endif
                        @foreach(\App\Models\Page::where('header','=',1)->get() as $data)

                            <li><a href="{{ route('frontend.page',$data->slug) }}">{{ $data->title }}</a></li>
                        @endforeach
                        @if($gs->is_contact == 1)
                            <li><a href="{{ route('frontend.contact') }}">@lang('site.contact')</a></li>
                        @endif
                        <li>
                            <a href="javascript:;" data-toggle="modal" data-target="#track-order-modal"
                               class="track-btn">@lang('site.follow')</a>
                        </li>
                    </ul>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="footer-widget info-link-widget">
                    ...
                    <ul class="link-list">
                        ...
                        @foreach(\App\Models\Page::where('footer','=',1)->get() as $data)
                            <li>
                                <a href="{{ route('frontend.page',$data->slug) }}">
                    ...
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link login active" id="nav-log-tab1" data-toggle="tab" href="#nav-log1"
                           role="tab" aria-controls="nav-log" aria-selected="true">
                            ...
                            @lang('site.siginselller')
                        </a>
                        <a class="nav-item nav-link" id="nav-reg-tab1" data-toggle="tab" href="#nav-reg1" role="tab"
                           aria-controls="nav-reg" aria-selected="false">
                            {{--								{{ $langg->lang198 }}--}}
                            @lang('site.registerselller')
                        </a>
                    </div>
                </nav>
                                ...
                                <form action="{{ route('user.login.submit') }}" method="POST">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="password" class="Password" name="password"
                                               placeholder="{{trans('site.password')}}" required="">
                                    ...
                                    <button type="submit" class="submit-btn">@lang('site.submit')</button>
                                ...
                                <form action="{{route('user-register-submit')}}"
                                    ...
                                    <div class="form-input">
                                        <input type="text" class="User Name" name="address"
                                               placeholder="{{trans('site.address')}}" required="">
                ...
                <div class="login-area">
                    ...
                    <div class="login-form">
                        ...
                        <form id="mforgotform" action="{{route('user-forgot-submit')}}" method="POST">
                            ...
                            <input class="fauthdata" type="hidden" value="">
                            <button type="submit" class="submit-btn">
                                {{--                                    {{ $langg->lang196 }}--}}
                                @lang('site.submit')
                            </button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="shop_name"
                                                       placeholder="{{trans('site.shop_name')}}" required="">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="owner_name"
                                                       placeholder="{{trans('site.owner_name')}}" required="">
                                                <i class="icofont-cart"></i>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="shop_number"
                                                       placeholder="{{trans('site.shop_number')}}" required="">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="shop_address"
                                                       placeholder="{{trans('site.shop_address')}}" required="">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="reg_number"
                                                       placeholder="{{trans('site.reg_number')}}" required="">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-input">
                                                <input type="text" class="User Name" name="shop_message"
                                                       placeholder="{{trans('site.shop_message')}}" required="">
                                        ...
                                        @if($gs->is_capcha == 1)
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-input">
                                                    <input type="text" class="Password" name="codes"
                                                           placeholder="{{ trans('site.code') }}" required="">
                                                    <i class="icofont-refresh"></i>
            ...
            <div class="modal-body">
                ...
                <div class="order-tracking-content">
                    <form id="track-form" class="track-form">
                        {{ csrf_field() }}
                        <input type="text" id="track-code" placeholder="" required="">
...
<script>
    var mainurl = "{{ \URL::to('/') }}";
    var langg = {
        'add_cart': '{{trans("site.addtocart")}}',
        'out_stock': '{{trans("site.out_stock")}}',
        'already_cart': '{{trans("site.already_cart")}}',
        'already_wish': '{{trans("site.already_wish")}}',
        'add_wish': '{{trans("site.add_wish")}}',
    }
</script>
