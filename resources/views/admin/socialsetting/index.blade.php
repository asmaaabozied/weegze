...
<div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.Social Links') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-social-index') }}">{{ __('site.Social Links') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              <form id class="form-horizontal" action="{{ route('admin-social-update-all') }}" method="POST">
              {{ csrf_field() }}
