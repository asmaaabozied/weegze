...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Google Login') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-social-google') }}">{{ __('site.Google Login') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $data->g_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-social-googleup',1)}}" {{ $data->g_check == 1 ? 'selected' : '' }}>{{ __('site.active') }}</option>
                                      <option data-val="0" value="{{route('admin-social-googleup',0)}}" {{ $data->g_check == 0 ? 'selected' : '' }}>{{ __('site.inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
