...
@section('content')
          <div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.Disputes') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="javascript:;">{{ __('site.Disputes') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
                            ...
                            <div class="contact-form">
                                <form >
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input type="text" class="input-field" id="order" name="order_number" placeholder="{{ __('site.number') }} *" value="" required="">
                                        </li>
