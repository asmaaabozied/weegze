...
{{--                                    {{csrf_field()}}--}}
                                    {{ BsForm::resource('subscription')->putModel($data, route('admin-subscription-update', $data)) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" name="currency" placeholder="{{ __("site.Currency Symbol") }}" required="" value="{{$data->currency}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" name="currency_code" placeholder="{{ __("site.code") }}" required="" value="{{$data->currency_code}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" name="price" placeholder="{{ __("site.cost") }}" required="" value="{{$data->price}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" name="valueday" placeholder="{{ __("site.Days") }}" required="" value="{{$data->days}}">
                                        </div>
                                    </div>
