                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form  action="{{route('admin-review-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
...
{{--                                <p class="sub-heading">{{ __('(In Any Language)') }}</p>--}}
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle" placeholder="{{ __('site.Sub Title') }}" value="{{$data->subtitle}}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="nic-edit" name="details" placeholder="{{ __('site.description') }}">{{ $data->details }}</textarea>
                          </div>
                        </div>
