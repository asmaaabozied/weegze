...
<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Child Categories') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('site.dashboard') }} </a>
											</li>
											<li><a href="javascript:;">{{ __('site.Manage Categories') }}</a></li>
											<li>
												<a href="{{ route('admin-childcat-index') }}">{{ __('site.Child Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
      	...
      	$(function() {
        	...
        	'<a class="add-btn" href="{{route('admin-childcat-create')}}">'+
