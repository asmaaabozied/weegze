...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.add') }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('site.back') }}</a></h4>
                    <ul class="links">
                        <li>
                        ...
                        <div class="body-area">
                            ...
                            <form  action="{{route('admin-discounts-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select id="sup_name" required="" name="discount_id[]" multiple="multiple" class="js-example-placeholder-multiple js-states form-control">
