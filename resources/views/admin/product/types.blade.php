...
@section('content')
    <div class="content-area">
        ...
        {{--	<form  action="{{route('admin-prod-update',$data->id)}}" method="POST"--}}
                            ...
                            <div class="product-description">
                                <div class="body-area">
                                    ...
                                    <div class="row link {{ $data->link != null ? '':'hidden' }}">
                                        ...
                                        <div class="col-lg-12">
											<textarea class="input-field" rows="4" name="link" placeholder="{{ __("site.link") }}"
                                ...
                                <div class="body-area">
                                    ...
                                    @foreach(\App\Models\Currency::get() as $currency)
                                        ...
                                        <div class="row">
                                            ...
                                            {{--                                                                                    @foreach($currencyproduct as $currprod)--}}
