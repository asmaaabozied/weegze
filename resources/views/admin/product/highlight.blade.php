								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form  action="{{route('admin-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}

												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.featured") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.best") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.top") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.big") }}*</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.hot") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.latest") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.trending") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("site.sale") }}*</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-6">
														<div class="left-area">
																<h4 class="heading">{{ __("site.Discount Date") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-6">
									                      <input type="text" class="input-field" name="discount_date"  placeholder="{{ __("site.Discount Date") }}" id="discount_date" value="{{ $data->discount_date }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<button class="addProductSubmit-btn" type="submit">{{ __("site.submit") }}</button>
													</div>
												</div>
