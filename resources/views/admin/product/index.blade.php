            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="javascript:;">{{ __("site.products") }} </a>
                        </li>
                        <li>
                            <a href="{{ route('admin-prod-index') }}">{{ __("site.All Products") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="mr-table allproduct">
                        <div class="col-sm-12 table-contents">
                            <a class="add-btn" href="{{route('admin-prod-types')}}">
                                <i class="fas fa-plus"></i> <span class="remove-mobile">{{ trans('site.add') }}<span>
                                   </span>
                            </a>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
            ...
            columns: [
                ...
                {data: 'status', searchable: false, orderable: false, printable: false},
                {data: 'action', searchable: false, orderable: false, printable: false}
        ...
        $(function () {
            ...
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                ...
                '<i class="fas fa-plus"></i> <span class="remove-mobile">' + mesg + '<span>' +
                '</a>' +
                '</div>');
        });
