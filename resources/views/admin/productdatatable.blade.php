...
@section('styles')
    ...
    <style type="text/css">
        ...
        button.dt-button, div.dt-button, a.dt-button {
            ...
            background-image: -webkit-linear-gradient(top, #110a73 0%, #1f68b6 100%) !important;
            background-image: -moz-linear-gradient(top, #110a73 0%, #1f68b6 100%) !important;
...
@section('content')
    ...
    <div class="content-area">
        ...
        <form action="{{route('getReportproducts')}}" method="get">
            <div class="product-area">
                <div class="row">
                    <div class="col-lg-2 text-right">
                        <div class="left-area">
                            <label class="text-center">{{ __('site.start_at') }}</label>
                            <input type="date" class="input-field date" name="start_at"
                                   placeholder="{{ __('Select a date') }}"  value="">
                        </div>
                    </div>
                    <div class="col-lg-2 text-right">
                        <div class="left-area">
                            <label class="text-center">{{ __('site.end_at') }}</label>
                            <input type="date" class="input-field date" name="end_at"
                                   placeholder="{{ __('Select a date') }}" value="">
                        </div>
                    </div>
                    <div class="col-lg-3 text-right">
                        <label class="text-center">{{ __('site.select') }}</label>
                        <br><br>


                        <select class="form-control" id="prevdate" name="status">
                            {{--                        <option>{{trans('site.select')}}</option>--}}
                            <option value="1">{{trans('site.active')}}</option>
                            <option value="0">{{trans('site.inactive') }}</option>
                    ...
                    <div class="col-lg-3 text-right">
                        ...
                        <select class="form-control" id="prevdate" name="status1">
                            <option value="is_catalog">{{trans("site.Catalog Products")  }}</option>
                            <option value="discount">{{trans("site.Discounted products") }}</option>
                    ...
                    <div class="col-lg-1 text-right">
                        <br><br>
                        <button class="btn btn-success" type="submit">{{trans('site.search')}}</button>
                    </div>
                </div>
            </div>
        </form>
