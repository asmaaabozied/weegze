...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Top Small Banners') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="javascript:;">{{ __('site.Top Small Banners') }}</a>
											</li>
										</ul>
								</div>
							</div>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
      	...
      	$(function() {
        	...
        	'<a class="add-btn" href="{{route('admin-sb-create')}}" id="add-data" >'+
