...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Bottom Small Banners') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="javascript:;">{{ __('site.Bottom Small Banners') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
      ...
      <!-- Modal body -->
      <div class="modal-body">
          <p class="text-center">{{ __('site.You are about to delete this Banner.') }}</p>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
      	...
      	$(function() {
        	...
        	'<a class="add-btn" href="{{route('admin-sb-create-bottom')}}" id="add-data">'+
