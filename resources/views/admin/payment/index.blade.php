...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Payment Gateways') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-payment-index') }}">{{ __('site.Payment Gateways') }}</a>
											</li>
										</ul>
								</div>
							</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        ...
									                        <th width="50%">{{ __('site.details') }}</th>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">{{ __('site.You are about to delete this Payment') }}.</p>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
      	...
      	$(function() {
            ...
            @if(auth()->guard('admin')->user()->hasPermission('create_paymentgateway'))
