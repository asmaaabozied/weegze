...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Error Page Banner') }} </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="javascript:;">{{ __('site.Error Page Banner') }} </a>
                        </li>
                      </ul>
                  </div>
                </div>
...
{{--                                                style="background: url({{ $gs->error_banner ? asset('assets/images/'.$gs->error_banner):asset('assets/images/noimage.png') }});"--}}
