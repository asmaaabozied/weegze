...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Payment Informations') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-gs-payments') }}">{{ __('site.Payment Informations') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
...
{{--                          --}}
                        ...
                        <form action="{{ route('admin-gs-update-payment') }}"  method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->stripe_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-stripe',1)}}" {{ $gs->stripe_check == 1 ? 'selected' : '' }}>{{ __('site.active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-stripe',0)}}" {{ $gs->stripe_check == 0 ? 'selected' : '' }}>{{ __('site.inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Stripe Key') }}"  value="{{ $gs->stripe_key }}" name="stripe_key"  required="">
{{--                              --}}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Stripe Secret') }}" value="{{ $gs->stripe_secret }}" name="stripe_secret"  required="">
{{--                              --}}
                          </div>
                        </div>
...
<hr>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->paypal_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-paypal',1)}}" {{ $gs->paypal_check == 1 ? 'selected' : '' }}>{{ __('site.active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-paypal',0)}}" {{ $gs->paypal_check == 0 ? 'selected' : '' }}>{{ __('site.inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Paypal Email') }}"  value="{{ $gs->paypal_business }}" name="paypal_business"  required="">
{{--                             --}}
                          </div>
                        </div>
...
<hr>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_instamojo == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-instamojo',1)}}" {{ $gs->is_instamojo == 1 ? 'selected' : '' }}>{{ __('site.active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-instamojo',0)}}" {{ $gs->is_instamojo == 0 ? 'selected' : '' }}>{{ __('site.inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Instamojo API Key') }}"  value="{{ $gs->instamojo_key }}" name="instamojo_key" required="">
{{--                              --}}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Instamojo Auth Token') }}"   value="{{ $gs->instamojo_token }}" name="instamojo_token" required="">
{{--                             --}}
                          </div>
                        </div>
...
<hr>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_paystack == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-paystack',1)}}" {{ $gs->is_paystack == 1 ? 'selected' : '' }}>{{ __('site.active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-paystack',0)}}" {{ $gs->is_paystack == 0 ? 'selected' : '' }}>{{ __('site.inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Paystack Public Key') }}"  value="{{ $gs->paystack_key }}" name="paystack_key"  required="">
{{--                              --}}
                          </div>
                        </div>
...
{{--                              --}}
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="input-field" placeholder="{{ __('Paytm Merchant') }}"   value="{{ $gs->paytm_merchant }}" name="paytm_merchant"  required="">
{{--                                --}}
                            </div>
                          </div>
...
<hr>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Withdraw Fee') }}" name="withdraw_fee" required="" value="{{ $gs->withdraw_fee }}">
{{--                              --}}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Withdraw Charge(%)') }}" name="withdraw_charge"  required=""   value="{{ $gs->withdraw_charge }}">
{{--                            -}}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Tax(%)') }}" name="tax" required="">
{{--                              value="{{ $gs->tax }}"--}}
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field"  value="{{ $gs->fixed_commission * $curr->value }}"  placeholder="{{ __('Fixed Commission') }}" name="fixed_commission"  required="">
{{--                             --}}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text"  value="{{ $gs->percentage_commission }}" class="input-field" placeholder="{{ __('Percentage Commission') }}" name="percentage_commission"  required="">
{{--                              --}}
                          </div>
                        </div>
