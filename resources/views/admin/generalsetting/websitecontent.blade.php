...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Website Contents') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-gs-contents') }}">{{ __('site.Website Contents') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('site.title1') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Write Your Site Title Here') }}" name="title" value="" required="">
                              {{ $gs->title }}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="number" class="input-field" placeholder="{{ __('Whole Sale Max Quantity') }}" name="wholesell" value="" required="" min="0">
                              {{ $gs->wholesell }}
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="input-field color-field" name="colors" value=""  class="form-control cp"  />
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="form-group">
                                <div class="input-group colorpicker-component cp">
                                  <input type="text" class="input-field color-field" name="footer_color" value=""  class="form-control cp"  />
                                    {{ $gs->footer_color }}
                                  <span class="input-group-addon"><i></i></span>
                                </div>
                              </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="form-group">
                                <div class="input-group colorpicker-component cp">
                                  <input class="input-field color-field" type="text" name="copyright_color" value=""  class="form-control cp"  />
                                    {{ $gs->copyright_color }}
                                  <span class="input-group-addon"><i></i></span>
                                </div>
                              </div>
