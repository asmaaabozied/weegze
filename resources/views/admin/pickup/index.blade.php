...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Pickup Locations') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-pick-index') }}">{{ __('site.Pickup Locations') }}</a>
											</li>
										</ul>
								</div>
							</div>
    ...
    <script type="text/javascript">
		...
		var table = $('#example').DataTable({
      	...
      	$(function() {
        	...
        	'<a class="add-btn" href="{{route('admin-pick-create')}}" id="add-data">'+
