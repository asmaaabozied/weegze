...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.taxes') }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('site.dashboard') }} </a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ __('site.taxes') }} </a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="mr-table allproduct">
                        ...
                        <div class="table-responsiv">
                            <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0"
                                ...
                                <thead>
                                <tr>
                                    <th width="40%">{{ __('site.name') }}</th>
                                    <th>{{ __('site.discounts') }}</th>
                                    <th>{{ __('site.type') }}</th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" href="{{route('tax.create')}}">' +
