...
@section('content')
    ...
    <div class="content-area">
        ...
        <form action="{{route('getReportorders')}}" method="get">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 text-right">
                        ...
                        <select class="form-control" id="prevdate" name="status">
                            ...
                            <option value="completed">{{trans('site.Completed')}}</option>
                            <option value="pending">{{trans('site.Pending')}}</option>
                            <option value="processing">{{trans('site.Processing') }}</option>
                            <option value="declined">{{trans('site.Declined') }}</option>
