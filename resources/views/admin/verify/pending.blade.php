...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("site.Pending Verifications") }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __("site.dashboard") }} </a>
											</li>
											<li><a href="javascript:;">{{ __('site.Vendor Verifications') }}</a></li>
											<li>
												<a href="{{ route('admin-vr-index') }}">{{ __("site.Pending Verifications") }}</a>
											</li>
										</ul>
								</div>
							</div>
