...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.Main Categories') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin-cat-index') }}">{{ __('site.Main Categories') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
{{--var site={{trans('site.add')}}--}}
    ...
    $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" href="{{route('admin-cat-create')}}" >' +
