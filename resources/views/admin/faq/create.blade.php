...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('site.Add New Faq') }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __("site.back") }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-faq-create') }}">{{ __('site.add') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
