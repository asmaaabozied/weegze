...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("site.Sub Categories") }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin-subcat-index') }}">{{ __("site.Sub Categories") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" href="{{route('admin-subcat-create')}}" >' +
