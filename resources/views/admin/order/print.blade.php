...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
    ...
    {{asset('assets/images/'.$gs->favicon)}}
  <style type="text/css">
            ...
            <div class="invoice__metaInfo" style="margin-top:0px;">
                ...
                <div class="col-lg-6" style="width:50%;">
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                            ...
                            <span><strong>{{ __('site.country') }}</strong>: {{ $order->customer_country }}</span>
                        </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($product['size'])
                                               <p>
                                                    <strong>{{ __('site.size') }} :</strong> {{str_replace('-',' ',$product['size'])}}
                                               </p>
                                               @endif
                                               @if($product['color'])
                                                <p>
                                                        <strong>{{ __('site.color') }} :</strong> <span style="width: 20px; height: 5px; display: block; border: 10px solid {{$product['color'] == "" ? "white" : '#'.$product['color']}};"></span>
                                                </p>
                                                @endif
                                                <p>
...
{{--                                                        {{\App\Models\Product::where('id',$product['item']['id'] )->first()->tax->discount ?? ''}}--}}
                                        ...
                                        <tr class="semi-border">
                                            <td colspan="1"></td>
                                            <td><strong>{{ __('site.Subtotal') }}</strong></td>
                                        ...
                                        <tr class="no-border">
                                            <td colspan="1"></td>
                                            <td><strong>{{ __('site.discount') }}({{$order->currency_sign}})</strong></td>
                                            <td>{{$order->currency_sign}}{{round($order->coupon_discount, 2)}}</td>
                                        </tr>
                                        @endif
                                        <tr class="final-border">
                                            <td colspan="1"></td>
                                            <td><strong>{{ __('site.total') }}</strong></td>
