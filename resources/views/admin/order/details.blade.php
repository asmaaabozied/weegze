...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.details') }} <a class="add-btn" href="javascript:history.back();"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="javascript:;">{{ __('site.details') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="order-table-wrap">
                    ...
                    <div class="special-box">
                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                <tbody>
                                <tr>
                                    <th class="45%" width="45%">{{ __('site.id') }}</th>
                                    <td width="10%">:</td>
                                    <td class="45%" width="45%">{{$order->order_number}}</td>

                                </tr>
                                <tr>
                                    <th width="45%">{{ __('site.total') }}</th>
                                    <td width="10%">:</td>
                                ...
                                <tr>
                                    <th width="45%">{{ __('site.date') }}</th>
                                    <td width="10%">:</td>
                                    <td width="45%">{{date('d-M-Y H:i:s a',strtotime($order->created_at))}}</td>
                                </tr>
                                <tr>
                                    <th width="45%">{{ __('site.Payment Method') }}</th>
                                    <td width="10%">:</td>
                                ...
                                @if($order->method != "Cash On Delivery")
                                    ...
                                    @endif
                                    <tr>
                                        <th width="45%">{{$order->method}} {{ __('site.id') }}</th>
                                        <td width="10%">:</td>
                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                ...
                                @if($order->coupon_discount != null)
                                    <tr>
                                        <th width="45%">{{ __('site.discount') }}</th>
                                        <th width="10%">:</th>
            ...
            <div class="row">
                <div class="col-lg-12 order-details-table">
                    <div class="mr-table">
                        <h4 class="title">{{ __('site.products') }}</h4>
                        <div class="table-responsiv">
                            <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                <tr>
                                    <th width="10%">{{ __('site.id') }}</th>
                                    <th>{{ __('site.name') }}</th>
                                    <th>{{ __('site.status') }}</th>
                                    <th>{{ __('site.title1') }}</th>
                                    <th width="20%">{{ __('site.details') }}</th>
                                    <th width="10%">{{ __('site.price') }}</th>
                                </tr>
                                </tr>
                                </thead>
                                <tbody>
...
{{--                        <i class="fa fa-send"></i> {{ __('site.Send Email') }}--}}
{{--                    </a>--}}
{{--                </div>--}}
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header d-block text-center">
                    <h4 class="modal-title d-inline-block">{{ __('site.License Key') }}</h4>
                ...
                <div class="modal-body">
                    <p class="text-center">{{ __('The Licenes Key is') }} : <span id="key"></span> <a
                            href="javascript:;" id="license-edit">{{ __('Edit License') }}</a><a href="javascript:;"
                                                                                                 id="license-cancel"
                                                                                                 class="showbox">{{ __('site.Cancel') }}</a>
                    </p>
                                    ...
                                    <div class="contact-form">
                                        <form id="emailreply">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="email" class="input-field eml-val" id="eml" name="to"
                                                           placeholder="{{ __('site.email') }} *" value="" required="">
                                                </li>
                                                <li>
                                            ...
                                            <button class="submit-btn" id="emlsub"
                                                    type="submit">{{ __('site.Send Email') }}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="confirm-delete2" tabindex="-1" role="dialog" aria-labelledby="modal1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header d-block text-center">
                    <h4 class="modal-title d-inline-block">{{ __('site.Update Status') }}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <p class="text-center">{{ __("site.You are about to update the order's status.") }}</p>
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <a class="btn btn-success btn-ok order-btn">{{ __('site.Proceed') }}</a>
                </div>
