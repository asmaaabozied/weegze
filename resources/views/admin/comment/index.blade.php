...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('site.Comments') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-comment-index') }}">{{ __('site.Comments') }}</a>
											</li>
										</ul>
								</div>
							</div>
									...
									<div class="mr-table allproduct">
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        <th width="20%">{{ __('site.products') }}</th>
									                        <th width="20%">{{ __('site.Commenter') }}</th>
									                        <th width="40%">{{ __('site.Comments') }}</th>
