...
@section('content')
          ...
          <div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('site.Packagings') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-package-index') }}">{{ __('site.Packagings') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(function() {
          ...
          '<a class="add-btn" href="{{route('admin-package-create')}}" id="add-data" >'+
