							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="javascript:;">{{ __('site.Blog') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-cblog-index') }}">{{ __('site.categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
    ...
    <script type="text/javascript">
		...
		var table = $('#example').DataTable({
      	...
      	$(function() {
            ...
            @if(auth()->guard('admin')->user()->hasPermission('create_Blogs'))

            $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" href="{{route('admin-cblog-create')}}" >'+
