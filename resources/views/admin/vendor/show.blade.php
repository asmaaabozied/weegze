...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __("site.details") }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __("site.back") }}</a></h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('admin-vendor-show',$data->id) }}">{{ __("site.details") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <th>{{ __("site.Joined") }}</th>
                                                            <td>{{ $data->created_at->diffForHumans() }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th width="35%">{{ __("site.details") }}</th>
                                                                        ...
                                                                        <td><a href="{{ route('front.product', $dt->slug) }}" target="_blank">{{ sprintf("%'.08d",$dt->id) }}</a></td>
                                                                            ...
                                                                            <td>
                                                                                <a href=" {{ route('admin-prod-edit',$dt->id) }}" class="view-details">
                                                                                    <i class="fas fa-eye"></i>{{ __("site.Details") }}
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                            ...
                            <div class="contact-form">
                                <form  action="{{route('sendmessages')}}"  method="post">
                                    ...
                                    <button class="submit-btn" id="emlsub"
                                            type="submit">@lang('site.Send Message')</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="top-area">
                            <div class="row">
                                <div class="col-sm-12 d-inline-block">
                                        ...
                                        <h5> @lang('site.details'): <small id="detail"></small></h5>
                                </div>
