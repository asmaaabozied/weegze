		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						<a href="javascript:;">{{ __("site.edit") }}</a>
					</li>
				</ul>
			</div>
		</div>
	</div>
    {{ BsForm::resource('import')->putModel($data, route('admin-import-update', $data)) }}
    @include('partials._errors')
{{--    {{ BsForm::resource('import')->putModel($data, route(''admin-import-update', $data)) }}--}}
{{--    @include('partials._errors')--}}

{{--	<form  action="{{route('admin-import-update',$data->id)}}" method="POST"--}}
											...
											<div class="col-lg-12">
												<select name="product_condition">
													<option value="2" {{$data->product_condition == 2
															? "selected":""}}>{{ __("site.New") }}</option>
													<option value="1" {{$data->product_condition == 1
															? "selected":""}}>{{ __("site.Used") }}</option>
												</select>
											</div>
										...
										<div class="col-lg-12">
											<div class="featured-keyword-area">
												<div class="heading-area">
													<h4 class="title">{{ __("site.Feature Tags") }}</h4>
												</div>
	...
	<div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle">{{ __("site.Image Gallery") }}</h5>
