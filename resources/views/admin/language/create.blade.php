    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="links">
          ...
          <li><a href="javascript:;">{{ __('site.Language Settings') }}</a></li>
          <li>
            <a href="{{ route('admin-lang-index') }}">{{ __('site.Website Language') }} </a>
          </li>
          <li>
            <a href="{{ route('admin-lang-create') }}">{{ __('site.Add Language') }}</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="product-description">
          <div class="body-area">
            ...
            <form  action="{{route('admin-lang-create')}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="left-area">
                    <h4 class="heading">{{ __('site.language') }} *</h4>
