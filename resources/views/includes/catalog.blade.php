            ...
            <div class="body-area">
              <form id="catalogForm" action="{{ route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')]) }}" method="GET">
                ...
                <ul class="filter-list">
                  @foreach (\App\Models\Category::get() as $element)
                  <li>
                    <div class="content">
                ...
                <div class="price-range-block">
                  ...
                  <button class="filter-btn" type="submit">{{trans('site.submit')}}</button>
              </form>
            </div>
            </div>
                ...
                <ul class="list">
                  <li>
                      <a href="javascript:;" data-toggle="modal" data-target="{{ Auth::guard('web')->check() ? '#vendorform1' : '#comment-log-reg' }}">
                          <i class="icofont-email"></i> <span class="service-text">langg->lang22</span>
                      </a>
                  </li>
                  <li>
