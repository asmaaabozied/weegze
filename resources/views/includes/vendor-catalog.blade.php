          ...
          <div class="left-area">
            ...
            <div class="body-area">
              ...
              <form class="price-range-block" id="priceForm" action="{{ route('front.vendor', Request::route('category')) }}">
                ...
                <button class="filter-btn" type="button" onclick="document.getElementById('priceForm').submit();">{{trans('site.submit')}}</button>
            </div>
            </div>
                ...
                <ul class="list">
                  <li>
                      <a href="javascript:;" data-toggle="modal" data-target="{{ Auth::guard('web')->check() ? '#vendorform1' : '#comment-log-reg' }}">
                          <i class="icofont-email"></i> <span class="service-text">{{trans('site.vendor')}} </span>
                      </a>
                  </li>
                  <li>
