					...
					<div class="user-profile-details">
						<div class="order-history">
							<div class="header-area">
								<h4 class="title">
                                    @lang('site.user-message-index') <a data-toggle="modal" data-target="#vendorform" class="mybtn1" href="javascript:;"> <i class="fas fa-envelope"></i>@lang('site.user-message-index')</a>
								</h4>
							</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="vendorformLabel">{{ trans('site.message') }}</h5>
            ...
            <div class="col-md-12">
              <div class="contact-form">
                <form >
                  ...
                  <ul>
                    <li>
                      <input type="text" class="input-field" id="subj1" name="subject" placeholder="{{ trans('site.subject')}} *" required="">
                    </li>
                    <li>
                      <textarea class="input-field textarea" name="message" id="msg1" placeholder="{{ trans('site.message') }} *" required=""></textarea>
                    </li>
                    <input type="hidden"  name="type" value="Ticket">
                  </ul>
                  <button class="submit-btn" id="emlsub1" type="submit">{{ trans('site.submit') }}</button>
                </form>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
     ...
     $.ajax({
        ...
        if(data == 0)
          toastr.error("{{ trans('site.error') }}");
        else
          toastr.success("{{ trans('site.message_sent') }}");
        $('.close').click();
            }
