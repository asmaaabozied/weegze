					...
					<div class="user-profile-details">
						<div class="order-history">
							<div class="header-area d-flex align-items-center">
								<h4 class="title">{{ trans('site.message') }}</h4>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="vendorformLabel">@lang('site.message')</h5>
              ...
              <div class="contact-form">
                <form >
                  ...
                  <ul>
                    ...
                    <li>
                      <input type="email" class="input-field" id="eml" name="email" placeholder="{{ trans('site.email')}} *" required="">
                    </li>


                    <li>
                      <input type="text" class="input-field" id="subj" name="subject" placeholder="{{trans('site.subject')}} *" required="">
                    </li>

                    <li>
                      <textarea class="input-field textarea" name="message" id="msg" placeholder="{{ trans('site.message') }} *" required=""></textarea>
                    </li>
                  ...
                  <button class="submit-btn" id="emlsub" type="submit">{{ trans('site.submit') }}</button>
                </form>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
     ...
     $.ajax({
        ...
        if(data == 0)
          toastr.error("{{ trans('site.NotEmail')}}");
        else
