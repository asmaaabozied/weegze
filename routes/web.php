...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']],
    function () {
        ...
        Route::get('/city/datatables', 'Admin\CityController@datatables')->name('city.datatables'); //JSON REQUEST
        Route::get('city/destory/{id}', 'Admin\CityController@destroy')->name('city.destroy');


        Route::resource('country', 'Admin\CountryController')->except('show');
        Route::get('country/destory/{id}', 'Admin\CountryController@destroy')->name('country.destroy');


        Route::get('/country/datatables', 'Admin\CountryController@datatables')->name('country.datatables'); //JSON REQUEST
...
//            Route::group(['middleware' => 'permissions:orders'], function () {
            Route::post('/sendmessages', 'Admin\OrderController@sendmessages')->name('sendmessages');
            Route::get('/permissions/datatables', 'Admin\PermissionController@datatables')->name('admin-permissions-datatables'); //JSON REQUEST
            Route::get('/permissions', 'Admin\PermissionController@index')->name('admin-permisssions-index');
            Route::get('/permissioncreate', 'Admin\PermissionController@create')->name('admin-permissions-create');
            Route::get('/permissiondelete/delete/{id}', 'Admin\PermissionController@destroy')->name('admin-permissions-delete');

            Route::get('/admin-permissions-edit/{id}', 'Admin\PermissionController@edit')->name('admin-permissions-edit');
            Route::post('/admin-permissions-update/{id}', 'Admin\PermissionController@update')->name('admin-permissions-update');


            Route::post('/permissioncreate', 'Admin\PermissionController@store')->name('admin-permissionss-create');
            ...
            Route::get('/getReportinquiries', 'Admin\ReportsController@getReportinquiries')->name('getReportinquiries');
            Route::get('/getReportproducts', 'Admin\ReportsController@getReportproducts')->name('getReportproducts');
            Route::get('/getReportvisitore', 'Admin\ReportsController@getReportvisitore')->name('getReportvisitore');

            Route::get('/getReportorders', 'Admin\ReportsController@getReportorders')->name('getReportorders');

            Route::get('/getReportvendors', 'Admin\ReportsController@getReportvendors')->name('getReportvendors');
...
//            Route::group(['middleware' => 'permissions:products'], function () {
            ...
            Route::get('/discounts/datatables', 'Admin\DiscountController@datatables')->name('admin-discounts-datatables'); //JSON REQUEST
            Route::get('/discounts', 'Admin\DiscountController@index')->name('admin-discounts-index');
            Route::get('/discounts/delete/{id}', 'Admin\DiscountController@destroy')->name('admin-discounts-delete');
            Route::get('/discounts/edit/{id}', 'Admin\DiscountController@edit')->name('admin-discounts-edit');
            Route::put('/discounts/edit/{id}', 'Admin\DiscountController@update')->name('admin-discounts-update');

            Route::get('/discounts/create', 'Admin\DiscountController@create')->name('admin-creatediscounts-index');
            Route::post('/discounts/create', 'Admin\DiscountController@store')->name('admin-discounts-store');
            ...
            Route::get('/productss/discount', 'Admin\ProductController@discount')->name('admin-prod-discount');
            Route::get('/productss/datatabless', 'Admin\ProductController@discountdatatables')->name('admin-productss-datatabless'); //JSON REQUEST
            ...
            Route::put('/products/edit/{id}', 'Admin\ProductController@update')->name('admin-prod-update');
            // EDIT SECTION ENDS
            Route::get('/inquiries/datatables', 'Admin\InquireController@datatables')->name('admin-inquiries-datatables'); //JSON REQUEST
            Route::get('/inquiries', 'Admin\InquireController@index')->name('admin-inquiries-index');
            Route::get('/inquiries/delete/{id}', 'Admin\InquireController@destroy')->name('admin-inquiries-delete');
            Route::get('/inquiries/{id}', 'Admin\InquireController@show')->name('admin-showinquiries-index');
...
//            Route::group(['middleware' => 'permissions:affilate_products'], function () {
            ...
            Route::put('/products/import/update/{id}', 'Admin\ImportController@update')->name('admin-import-update');
...
//            Route::group(['middleware' => 'permissions:customers'], function () {
            ...
            Route::get('/clients/datatables', 'Admin\UserController@datatablesclients')->name('admin-clients-datatables'); //JSON REQUEST
            Route::get('/clients', 'Admin\UserController@clients')->name('admin-clients-index');
            ...
            Route::post('/clients/store', 'Admin\UserController@store_clients')->name('admin-clients-store');
            Route::get('/clients/create', 'Admin\UserController@create_clients')->name('admin-clients-create');
...
//            Route::group(['middleware' => 'permissions:vendor_subscription_plans'], function () {
            ...
            Route::put('/subscription/edit/{id}', 'Admin\SubscriptionController@update')->name('admin-subscription-update');
...
//            Route::group(['middleware' => 'permissions:categories'], function () {
            ...
            Route::put('/category/edit/{id}', 'Admin\CategoryController@update')->name('admin-cat-update');
            ...
            Route::put('/attribute/store', 'Admin\AttributeController@store')->name('admin-attr-store');
            ...
            Route::put('/attribute/edit/{id}', 'Admin\AttributeController@update')->name('admin-attr-update');
            ...
            Route::put('/subcategory/edit/{id}', 'Admin\SubCategoryController@update')->name('admin-subcat-update');
            ...
            Route::put('/childcategory/edit/{id}', 'Admin\ChildCategoryController@update')->name('admin-childcat-update');
...
//            Route::group(['middleware' => 'permissions:product_discussion'], function () {
            ...
            Route::get('/general-settings/products/{status}', 'Admin\GeneralSettingController@products')->name('admin-gs-products');
...
//            Route::group(['middleware' => 'permissions:blog'], function () {
            ...
            Route::resource('tax', 'Admin\TaxController')->except('show');
            Route::get('/tax/datatables', 'Admin\TaxController@datatables')->name('tax-datatables'); //JSON REQUEST
            Route::get('/tax/delete/{id}', 'Admin\TaxController@destroy')->name('tax-delete'); //JSON REQUEST
            ...
            Route::put('/blog/category/edit/{id}', 'Admin\BlogCategoryController@update')->name('admin-cblog-update');
...
//            Route::group(['middleware' => 'permissions:general_settings'], function () {
            ...
            Route::put('/shipping/edit/{id}', 'Admin\ShippingController@update')->name('admin-shipping-update');
            ...
            Route::put('/package/edit/{id}', 'Admin\PackageController@update')->name('admin-package-update');
...
//            Route::group(['middleware' => 'permissions:home_page_settings'], function () {
            ...
            Route::put('/slider/edit/{id}', 'Admin\SliderController@update')->name('admin-sl-update');
...
//            Route::group(['middleware' => 'permissions:menu_page_settings'], function () {
            ...
            Route::put('/faq/update/{id}', 'Admin\FaqController@update')->name('admin-faq-update');
            ...
            Route::put('/page/update/{id}', 'Admin\PageController@update')->name('admin-page-update');
...
// Payment Gateways
            ...
            Route::put('/paymentgateway/update/{id}', 'Admin\PaymentGatewayController@update')->name('admin-payment-update');
...
// Currency Settings
            ...
            Route::put('/currency/update/{id}', 'Admin\CurrencyController@update')->name('admin-currency-update');
...
//            Route::group(['middleware' => 'permissions:seo_tools'], function () {
            ...
            Route::put('/seotools/analytics/update', 'Admin\SeoToolController@analyticsupdate')->name('admin-seotool-analytics-update');
...
// User Orders
            ...
            Route::get('/orders/status/{id1}/{id2}', 'Admin\OrderController@status')->name('admin-order-status');
...
// User Subscription
            ...
            Route::get('/molly/notify', 'User\MollyController@notify')->name('molly.notify');
            Route::post('/molly/submit', 'User\MollyController@store')->name('molly.submit');
            ...
            //PayTM Routes
            Route::post('/paytm/submit', 'User\PaytmController@store')->name('paytm.submit');;
            Route::post('/paytm/notify', 'User\PaytmController@notify')->name('paytm.notify');


            //PayTM Routes
            Route::post('/razorpay/submit', 'User\RazorpayController@store')->name('razorpay.submit');;
            Route::post('/razorpay/notify', 'User\RazorpayController@notify')->name('razorpay.notify');
...
// ************************************ VENDOR SECTION **********************************************
            ...
            Route::prefix('vendor')->group(function () {
                ...
                Route::put('/products/edit/{id}', 'Vendor\ProductController@update')->name('vendor-prod-update');

                Route::get('/products/catalog/{id}', 'Vendor\ProductController@catalogedit')->name('vendor-prod-catalog-edit');
                Route::put('/products/catalog/{id}', 'Vendor\ProductController@catalogupdate')->name('vendor-prod-catalog-update');
...
// ************************************ FRONT SECTION **********************************************
            ...
            Route::get('/{sign}', 'Front\FrontendController@getcurrency');
            ...
            // BLOG SECTION
            Route::get('/frontend/blogs', 'Front\FrontendController@blog')->name('frontend.blogs');
            ...
            Route::get('/frontend/faq', 'Front\FrontendController@faq')->name('frontend.faq');
            ...
            Route::get('/frontend/contact', 'Front\FrontendController@contact')->name('frontend.contact');

//            Route::get('/sss/asmaa', 'Front\FrontendController@contact')->name('front.sss.asmaa');
            ...
            Route::get('/searchcategory', 'Front\CatalogController@searchcategory')->name('front.searchcategory');
...
//            Route::get('/category/{category?}/{subcategory?}/{childcategory?}', 'Front\CatalogController@category')->name('front.category');
            ...
            Route::get('/frontends/categories/', 'Front\CatalogController@categories')->name('frontends.categories');
            ...
            Route::get('/frontendd/carts/', 'Front\CartController@cart')->name('frontendd.cart');
            ...
            // CHECKOUT SECTION
            Route::get('/frontend/checkout/', 'Front\CheckoutController@checkout')->name('frontend.checkout');
...
//            Route::get('/{slug}', 'Front\FrontendController@page')->name('front.page');
            Route::get('/frontend/{slug}', 'Front\FrontendController@page')->name('frontend.page');
            // PAGE SECTION ENDS
