    ...
    public function datatables()
    {
         ...
         return DataTables::of($datas)
                            ...
                            ->addColumn('action', function(Service $data) {
                                return '<div class="action-list"><a href="' . route('vendor-service-edit',$data->id) . '" class="edit"> <i class="fas fa-edit"></i>'.$this->vendor_language->lang717.'</a><a href="javascript:;" data-href="' . route('vendor-service-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            })
