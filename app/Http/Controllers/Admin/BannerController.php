    ...
    public function datatables($type)
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (Banner $data) {
                return '<div class="action-list"><a href="' . route('admin-sb-edit', $data->id) . '" class="edit" > <i class="fas fa-edit"></i>' . trans('site.edit') . '</a><a href="javascript:;" data-href="' . route('admin-sb-delete', $data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
            })
...
//        }
        ...
        return back();
//        return redirect(route('admin-sb-large'));
