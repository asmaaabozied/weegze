    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->addColumn('action', function(EmailTemplate $data) {
                                ...
                                $edit = '';
                                if (auth()->guard('admin')->user()->hasPermission('update_email-templates')) {
                                    $edit = '<a  href="' . route('admin-mail-edit', $data->id) . '" class="edit" >
...
//                                return '<div class="action-list"><a href="' . route('admin-mail-edit',$data->id) . '"> <i class="fas fa-edit"></i>'.trans('site.edit').'</a></div>';
                            })
